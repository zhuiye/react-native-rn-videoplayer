    ...
    speedLongTouch = (evt) => {
        ...
        if (speedStartX <= speedTouchWidth) {
            ...
            this.sloSpeedTime = setInterval(() => {
                this.nowCurrentTime &&
                    this.player.seek(this.nowCurrentTime - 5);
            }, 500);
    ...
    componentWillMount() {
        ...
        this._panResponder = PanResponder.create({
            ...
            onPanResponderMove: (evt, gestureState) => {
                ...
                if (
                    (this.LockRef && this.LockRef.state.lock) ||
                    this.speedTouch
                )
                    return; //锁定控件时 禁用手势
                ...
                if (this.recordHandeY.length === 10) {
                    if (
                        ...
                        if (Math.abs(this.moveYData) > 5) {
                            if (
                                ...
                                if (this.soundDataY) {
                                    ...
                                    if (this.soundData >= 1) {
                                        this.VolumeRef &&
                                            this.VolumeRef.setsoundWidth(100);
                                    }
                                    if (
                                        this.soundData >= 0 &&
                                        this.soundData <= 1
                                        ...
                                        this.VolumeRef &&
                                            this.VolumeRef.setsoundWidth(
                                                (this.soundData / 1) * 100
                                            );
                                    }
                                    if (
                                        this.soundData < 0 &&
                                        ...
                                        this.VolumeRef &&
                                            this.VolumeRef.setsoundWidth(0);
                                    }
                                }
                            }
                            ...
                            if (
                                ...
                                if (this.BrightnessY) {
                                    ...
                                    this.brightnessData =
                                        this.brightness + this.BrightnessY;
                        ...
                        if (this.state.onload && Math.abs(this.moveXData) > 0) {
                            ...
                            this.dotspeed &&
                                this.dotspeed.setdotWidth(this.reasut);
                        }
                    }
                }
            },
        ...
        this._panSpeeDot = PanResponder.create({
            ...
            onPanResponderRelease: (evt, gestureState) => {
                ...
                let speedB =
                    this.dotspeed.state.dotWidth / (this.state.width - 200);
                if (speedB >= 1) {
        ...
        try {
            ...
            if (!this.state.showOpenVip) {
                if (
                    ...
                    this.lastBackPressed + 300 >= Date.now()
                ) {
            ...
            <>
                ...
                >
                        ...
                        >
                            ...
                            >
                                <Video
                                    ...
                                    continuous={
                                        this.props.continuous ? true : false
                                    } //是否是连续剧，用来全屏展示选集，下一集按钮    重新加载Video标签，防止出现上个视频和下个视频分辨率不切换的问题
                                    {...propsObj}
                                    repeat={
                                        this.props.repeat
                                            ? this.props.repeat
                            ...
                            >
                                ...
                                >
                                    ...
                                    <Speed
                                        ...
                                        cacheColor={this.props.cacheColor}
                                        dotColor={this.props.dotColor}
                                        dotBorderColor={
                                            this.props.dotBorderColor
                                        }
                                        allSpeedColor={this.props.allSpeedColor}
                                        admRePlay={this.state.admRePlay}
                                        nowTime={this.nowTime}
                                        panHandlers={
                                            this._panSpeeDot.panHandlers
                                        }
                                        allTime={allTime}
                    ...
                    {this.adminPaused && this.state.paused && (
                        <TipsPaused
                            {...this.state}
                            pausedTipText={this.props.pausedTipText}
                        />
                    )}
