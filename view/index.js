    ...
    this._panResponder = PanResponder.create({
      ...
      onPanResponderMove: (evt, gestureState) => {
        if (this.recordHandeY.length < 10) {
          this.recordHandeY.push(evt.pageY);

          this.recordHandeX.push(evt.pageX);
        }
        // console.log("locationY", evt.nativeEvent.pageY)
        this.moveYData = this.startY - evt.pageY;
        if ((this.LockRef && this.LockRef.state.lock) || this.speedTouch)
          return; //锁定控件时 禁用手势
        // console.log("moveYData",)
        this.moveXData = evt.pageX - this.startX;
      ...
      onPanResponderMove: (evt, gestureState) => {
        ...
        if (this.realMarginLeft > 0) {
          ...
          this.dotspeed.setdotWidth(
            evt.pageX - 100 >= this.state.width - 200
                  ...
                  >
                    ...
                    <Text
                      style={{
                        ...
                        fontSize: 15,
                        paddingLeft: 10,
                        maxWidth: smallP ? width / 3 : height / 3,
                        ...this.props.backVideoNameStyle,
                      }}
                      numberOfLines={1}
                    >
                    ...
                    >
                      ...
                      {this.props.continuous && (
                        <TouchableOpacity
                          ...
                          onPress={() => {
                            this.props.nextBtnFun && this.props.nextBtnFun();
                          }}
                        >
                          <SvgVideoNextBtn
                            height="20"
