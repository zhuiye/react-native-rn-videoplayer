        ...
        <>
            {props.showLoading ? (
                ...
                >
                    ...
                    >
                        <Animated.View
                            style={{ transform: [{ rotate: props.spin }] }}
                        >
                            {props.loadingIcon ? (
                                props.loadingIcon
                            ) : (
    ...
    if (show) {
        return (
            ...
            >
                ...
                <Text style={styles.TipsPausedText}>
                    {props.pausedTipText ? props.pausedTipText : '已暂停'}
                </Text>
            </Animated.View>
        );
    } else {
        ...
        return (
            <>
                ...
                >
                    <Animated.View
                        style={{
                            ...
                            justifyContent: 'center',
                            transform: [
                                { rotateY: isSolTouch ? '180deg' : '0deg' },
                            ],
                        }}
                    >
                ...
                <Text style={{ color: '#fff', fontSize: 12 }}>
                    {isSolTouch ? solText : `${videoRate}x ${fastText}`}
                </Text>
            </>
        );
    }
                        ...
                        style={{
                            ...
                            width:
                                props.playBufferX === null
                                    ...
                                    : props.playBufferX,
                            height: 2,
                            backgroundColor: props.cacheColor,
                            position: 'absolute',
                            left: 10,
                        }}
                    ></Animated.View>
